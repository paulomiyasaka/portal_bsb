        ...
        <form id="form_reprocessar" class="row g-3">
          ...
          <div class="row">
            <div class="my-1">
              ...
              <input type="date" class="form-control" id="data_inicial" name="data_inicial" placeholder="dd/mm/aaaa" required>
            </div>
          </div>
          ...
          <div class="row">
            <div class="my-1">
              ...
              <input type="date" class="form-control" id="data_fim" name="data_fim" placeholder="dd/mm/aaaa" required>
            </div>
          </div>
          ...
          <div class="row">
            <div class="bg-warning bg-opacity-75 my-3">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="data_final" id="ciente" name="ciente" required>
